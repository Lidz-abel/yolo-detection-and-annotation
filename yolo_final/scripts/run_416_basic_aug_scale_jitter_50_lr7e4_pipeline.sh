...
RUN_PREFIX="dual_scale_three_box_coco_only_noobj1_416_basic_aug_scale_jitter_50_lr7e4_ddp"
...
echo "session=train_416_basic_aug_scale_jitter_50_lr7e4" | tee -a "${LOG}"
