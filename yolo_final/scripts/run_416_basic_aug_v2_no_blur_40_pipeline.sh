...
CONFIG="configs/dual_scale_three_box_coco_only_noobj1_416_basic_aug_v2_no_blur_40.toml"
RUN_PREFIX="dual_scale_three_box_coco_only_noobj1_416_basic_aug_v2_no_blur_40_ddp"
...
echo "session=train_416_basic_aug_v2_no_blur_40" | tee -a "${LOG}"
