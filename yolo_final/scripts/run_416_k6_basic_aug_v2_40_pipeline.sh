...
CONFIG="configs/dual_scale_three_box_coco_only_noobj1_416_k6_basic_aug_v2_40.toml"
RUN_PREFIX="dual_scale_three_box_coco_only_noobj1_416_k6_basic_aug_v2_40_ddp"
...
echo "session=train_416_k6_basic_aug_v2_40" | tee -a "${LOG}"
